    ...
    <div class="container media container_page">
        <div class="media-body">
            <div class="detail-news">
                <h1 class="article-title">Nàng Bạch Tuyết và bảy chú lùn.</h1>
                <ul class="single-meta">
                    <li>Update April 10, 2019</li>
                    <li><i class="icon icon-view"></i> 813.156 views</li>
                    <!-- <li><i class="icon icon-tag"></i> <a href="#">GSX-R1000R,</a> <a href="">GSX1100S KATANA
                            (GS1100S)</a></li> -->
...
Tuy vậy Thủy Tinh vẫn không quên được chuyện xưa. Hàng năm cứ vào khoảng tháng bảy, tháng tám là Thủy Tinh lại dâng nước lên đánh Sơn Tinh. .</p>
                <p class="source">(Sưu tầm)</p>
                <ul class="single-meta">
